addLayer("p", {
    ...
    color: "#31aeb0", // Fixed to classic Prestige Tree teal blue
    ...
    // Safe upgrade checking that will never crash the game on startup
    gainMult() { 
    ...
    gainExp() { 
        ...
        if (player.p && player.p.upgrades.includes(31)) {
